...
from weizhi.core.providers import DeepSeekProvider, FakeTextProvider, ProviderError
...
class _V1T2Provider(DeepSeekProvider):
    ...
    def build_messages(self, task, inputs):
        from weizhi.core.prompts import T2_SYSTEM, T2_USER
        return [
